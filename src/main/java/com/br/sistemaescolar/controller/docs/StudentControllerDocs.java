...
public interface StudentControllerDocs {
    ...
    StudentResponseDTO createStudent(@RequestBody StudentRequestDTO student);
    ...
    StudentResponseDTO findStudentById(@PathVariable("id") Long id);
    ...
    StudentResponseDTO updateStudent(@PathVariable("id") Long id, @RequestBody StudentRequestDTO student);
